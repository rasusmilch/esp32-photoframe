...
- Added standalone provisional ESP-IDF Wi-Fi epoch-fence tooling with a standard-library schema-1
  ...
  synchronized attempt context, exact scenario ordering, mode-aware stop masks, one fence, and a
  timed quiet quarantine; and rejects stale or demoted terminal evidence. Synthetic host validation
  passes, but production firmware is unchanged and ESP-IDF and physical E1002/E1004 acceptance
  remain pending.
